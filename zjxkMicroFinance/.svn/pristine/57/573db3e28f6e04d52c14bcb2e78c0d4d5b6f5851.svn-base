 ...
 * @author yuzhuo
 */
public class Mhouseloanform extends Model implements Serializable,ProcessForm {

    private static final long serialVersionUID = -1L;

    public Mhouseloanform(){}
    ...
    public void setHouseadress(String houseadress) {
        this.firePropertyChange("houseadress");
    ...
    public void setHousebuytime(Date housebuytime) {
        this.firePropertyChange("housebuytime");
    ...
    public void setHouseprice(BigDecimal houseprice) {
        this.firePropertyChange("houseprice");
