...
public class PasswordUtil {
	...
	// 十六进制下数字到字符的映射数组
	private final static String[] hexDigits = { "y", "z", "f", "r", "m", "e", "w", "o", "r", "k", "5", "5", "6", "6",
	        "8", "8" };

	private final static char[] passworditems = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'h', 'k', 'm', 'm', 'n',
	        'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I',
	        'H', 'K', 'M', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z' };
