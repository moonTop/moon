...
<form id="pagerForm" method="post" action="BK6001/doneList.do">
    <input type="hidden" name="pageNum" value="1" />
</form>

<div class="pageHeader">
<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="BK6001/doneList.do" method="post">
    <input type="hidden" id="numPerPage" name="numPerPage" value="${page.numPerPage}">
    <div class="searchBar">
        <div class="titleBar">
            <div class="navTitle">任务管理/</div><div class="pageTitle">已办列表</div>
        </div>
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="edit" href="BK6001/viewdone/{taskId}.do" title="已办任务" target="navTab" rel="BK6002"><span>查看已办任务</span></a></li>
            <li><a class="edit" href="BK6001/viewflow/{taskId}.do" title="流程图" target="dialog"  rel="BK6002" width="800" height="600"><span>查看流程图</span></a></li>
        </ul>
    </div>
    <table id="gridTable" class="table" width="100%" layoutH="153">
        <thead>
            <tr>
                ...
                <th width="200" style="font-weight:bold;">完成时间</th>
