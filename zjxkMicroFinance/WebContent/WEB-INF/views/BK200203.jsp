...
<div class="pageContent">
    <form id="BK200203Form" method="post">
...
<script type="text/javascript">
    // 初始化下拉菜单、单选按钮
    $("#BK200203Form").find("#gender").val("${model.gender}");
    $("#BK200203Form").find("input:radio[value=${model.marriage}]").attr("checked",true);
    // 全部不可编辑
    $("#BK200203Form").find("*").attr("disabled","disabled");
    // 审批意见列表
    $("#BK200203Form").find("#commentList").ajaxUrl({
        url:"BK6001/commentList.do",
        data:{taskId:$("#BK200203Form").find("#taskId").val()}
    });
</script>