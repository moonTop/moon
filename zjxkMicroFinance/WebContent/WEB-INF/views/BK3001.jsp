...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <li><a class="edit" href="BK3001/editMloanrecord/{id}.do" title="修改贷款信息" target="dialog" width="800" height="600" rel="BK300101"><span>修改</span></a></li>
            </c:if>
            <li><a class="edit" href="BK3001/viewMloanrecord/{id}.do" title="查看贷款信息" target="dialog" width="800" height="600" rel="BK300102"><span>查看</span></a></li>
        </ul>
    </div>
