...
<script src="../dths_js/js/commons/commonjsloader3.jsp" type="text/javascript"></script>
<script src="../dths_js/js/${beanNameLower}/${beanNameLower}.js" type="text/javascript"></script>
<script src="../dths_js/plugs/easyui/jquery.easyui.validext.js" type="text/javascript"></script>
			...
			<#assign  num=num+1>
				...
				<div class="fitem">
					...
					<#if field.fieldType=="String" && field.fieldLength !="2" && field.fieldName !="CREATEDATE" && field.fieldName !="CREATEUSER" && field.fieldName !="UPDATEDATE" && field.fieldName !="UPDATEUSER">
						<input id="${field.fieldName}" name="${field.fieldName}" type="text" class="easyui-validatebox" data-options="required:true" missingMessage="${field.remark}为必输项" maxlength="50" />
					<#else>
...
<!-- 文件上传div -->
<div id="uploadDiv"  class="easyui-dialog" style="width:530px; height:260px; text-align:center" title="上传附件"  closed="true">
        <iframe src="" id="iframepage" name="iframepage" frameBorder=0 scrolling=no width="100%"   height="98%"	 ></iframe> 
</div>
